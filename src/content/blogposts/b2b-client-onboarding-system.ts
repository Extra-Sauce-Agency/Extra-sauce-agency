export const clientOnboardingSystemBlogPost = {
  ...
  content: `
    <div class="prose prose-lg max-w-none">
      ...
      <p>Most agencies think onboarding ends after the kickoff call and a PDF checklist. The real issue is lack of intentional infrastructure to make clients feel supported from day one. Common problems include unclear timelines, confusing handoffs, slow response times, and static documentation.</p>
      
      <h3>Why Onboarding is Where Trust Is Won or Lost</h3>
      <p>Early actions either reinforce or erode the promises made during sales. When onboarding feels like a black box, confidence drops and churn risk rises. Our goal: make every client feel like they've added a high-performance extension to their team.</p>
      
      <h3>Shift 1: Instant Communication Through Slack</h3>
      <ul>
        <li>Dedicated Slack channels for every client</li>
        <li>Quick calls, voice notes, and instant responses</li>
        <li>Easy reference to past context</li>
      </ul>
      
      <h3>Shift 2: Clear Expectations and an 8-Week Roadmap</h3>
      <ul>
        <li>Role clarity and contribution expectations</li>
        <li>Week-by-week plan for the first 8 weeks</li>
        <li>Defined wins at each milestone</li>
      </ul>
      
      <h3>Shift 3: Total Transparency with a Notion Client Portal</h3>
      <ul>
        <li>Access to meeting notes, strategy docs, and content calendar</li>
        <li>Preview system for all assets in production</li>
        <li>Central hub for resources, templates, and training</li>
      </ul>
  ...
  slug: "client-onboarding-system-toronto-canada",
  featured: true,
  readTime: "6 min read"
};
