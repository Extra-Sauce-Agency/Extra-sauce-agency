export const personalBrandingVsFounderLedBlogPost = {
  id: "36",
  title: "Personal Branding vs. Founder-Led Marketing: Key Differences for B2B Growth",
  excerpt: "Discover how personal branding and founder-led marketing work together to build authority, drive inbound leads, and grow your B2B business.",
  content: `
    <div class="prose prose-lg max-w-none">
      ...
      <ul>
        <li><strong>Share unique perspectives</strong> on industry trends</li>
      ...
      <ol>
        <li>Align founder content with company goals</li>
  ...
  date: "2025-03-27",
  category: "Leadership",
  tags: ["personal branding", "founder-led marketing", "B2B growth", "Toronto", "Canada"],
  image: "https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=crop&w=1200&q=80",
  slug: "personal-branding-vs-founder-led-marketing",
  featured: false,
  readTime: "6 min read"
};
